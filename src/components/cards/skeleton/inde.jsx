...
const Skeleton = () => {
  return (
    <>
      <div
        role="status"
        className=" flex-col animate-pulse gap-4  flex md:items-center"
      >
        <div className="flex items-center justify-center w-[90%] h-40 bg-gray-300 rounded-sm  dark:bg-gray-700">
          <svg
